...
10. Let VibeBox auto-curate userRequest/userFeedback-first events into active, replaced, discarded, or quarantined memory. Structured requests are decomposed into reusable success criteria, project/user/domain patterns, validation and preservation rules, AI failure-prevention rules, and task context before AI action summaries are considered.
